...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    <img class="logo" src="resources/css/img/logo-white.png" alt="logo-white">
                    <img class="logo-black" src="resources/css/img/logo.png" alt="logo-black">
    ...
    <script src="vendors/js/jquery.waypoints.min.js.js"></script>
